...
async function createWallet(
    ...
    if (existing) {
        await WalletModel.updateOne(
            { _id: existing._id },
            { availableBalance: available, pendingBalance: pending }
        );
        return existing;
    }
...
const seed = async () => {
    try {
        ...
        // Market Categories
        let foodMkt = await MarketCategoryModel.findOne({
        ...
        let parcelMkt = await MarketCategoryModel.findOne({
        ...
        if (!parcelMkt) {
            parcelMkt = await MarketCategoryModel.create({
                ...
                thumbnail:
                    'https://images.unsplash.com/photo-1566576721346-d4a3b4eaad5b?w=500'
            });
        }
        ...
        if (!bikeType) {
            bikeType = await VehicleTypeModel.create({
                name: 'Motorbike',
                slug: 'motorbike',
                feePerKm: 150,
        ...
        if (!carType) {
            carType = await VehicleTypeModel.create({
                name: 'Car',
                slug: 'car',
                feePerKm: 250,
                icon: 'directions_car',
        ...
        const vendorUser2 = await UserModel.create({
            firstName: 'Pizza',
            lastName: 'Hub',
            email: 'vendor_pizza@nilab.com',
            password: PW,
            role: 'vendor',
            phoneNumber: '08022222222',
            kycStatus: 'verified'
        });
        const vendorUser3 = await UserModel.create({
            firstName: 'Drinks',
            lastName: 'World',
            email: 'vendor_drinks@nilab.com',
            password: PW,
            role: 'vendor',
        ...
        const riderUser1 = await UserModel.create({
            firstName: 'Jason',
            lastName: 'Swift',
            email: 'rider_jason@nilab.com',
            password: PW,
            role: 'rider',
            phoneNumber: '08033333331',
            kycStatus: 'verified'
        });
        const riderUser2 = await UserModel.create({
            firstName: 'Mark',
            lastName: 'Speed',
            email: 'rider_mark@nilab.com',
            password: PW,
            role: 'rider',
            phoneNumber: '08033333332',
            kycStatus: 'verified'
        });

        const custUser1 = await UserModel.create({
            firstName: 'Alice',
            lastName: 'Johnson',
            email: 'customer_alice@nilab.com',
            password: PW,
            role: 'user',
            phoneNumber: '08044444441',
            kycStatus: 'verified',
            addresses: [
                {
                    label: 'Home',
                    address: '123 VI Close',
                    street: 'VI Close',
                    city: 'Lagos',
                    state: 'Lagos',
        ...
        const custUser2 = await UserModel.create({
            firstName: 'Bob',
            lastName: 'Williams',
            email: 'customer_bob@nilab.com',
            password: PW,
            role: 'user',
            phoneNumber: '08044444442',
            kycStatus: 'verified',
            addresses: [
                {
                    label: 'Office',
        ...
        const custUser3 = await UserModel.create({
            firstName: 'Carol',
            lastName: 'Davis',
            email: 'customer_carol@nilab.com',
            password: PW,
            role: 'user',
            phoneNumber: '08044444443',
            kycStatus: 'verified'
        });
        ...
        const vendor1 = await VendorModel.create({
            ...
            location: {
                type: 'Point',
                coordinates: [3.4245, 6.4311],
                formattedAddress: '45 Burger Ave, VI, Lagos',
                street: 'Burger Ave',
                city: 'Lagos',
                state: 'Lagos'
            },
        ...
        const p_burger1 = await ProductModel.create({
            name: 'Classic Cheeseburger',
            description: 'Beef patty, cheddar, lettuce, tomato',
            price: 4500,
            vendor: vendor1._id,
            category: catMap['Burgers']._id,
            thumbnail:
                'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=500',
            stock: 50
        });
        const p_burger2 = await ProductModel.create({
            name: 'Double BBQ Burger',
            description: 'Two patties, BBQ sauce, crispy onions',
            price: 6500,
            vendor: vendor1._id,
            category: catMap['Burgers']._id,
            thumbnail:
        ...
        const p_burger3 = await ProductModel.create({
            name: 'Spicy Chicken Burger',
            description: 'Crispy chicken, spicy mayo, pickles',
            price: 5000,
            vendor: vendor1._id,
            category: catMap['Chicken']._id,
            thumbnail:
                'https://images.unsplash.com/photo-1606755962773-d324e0a13086?w=500',
            stock: 40
        });
        const p_burger4 = await ProductModel.create({
            name: 'Chicken Strip Basket',
            description: '6 crispy strips with dipping sauce',
            price: 3500,
            vendor: vendor1._id,
            category: catMap['Chicken']._id,
            thumbnail:
                'https://images.unsplash.com/photo-1562802378-063ec186a863?w=500',
            stock: 60
        });
        ...
        const vendor2 = await VendorModel.create({
            ...
            location: {
                type: 'Point',
                coordinates: [3.398, 6.455],
                formattedAddress: '12 Marina Drive, Lagos',
                street: 'Marina Drive',
                city: 'Lagos',
                state: 'Lagos'
            },
        ...
        const p_pizza1 = await ProductModel.create({
        ...
        const p_pizza2 = await ProductModel.create({
            name: 'Pepperoni Feast',
            description: 'Double pepperoni, cheese blend',
            price: 9000,
            vendor: vendor2._id,
            category: catMap['Pizza']._id,
            thumbnail:
        ...
        const vendor3 = await VendorModel.create({
            ...
            marketCategoryId: foodMkt._id,
            categories: [
                catMap['Drinks & Beverages']._id,
                catMap['Desserts']._id
            ],
            description: 'Refreshing beverages and sweet treats',
            location: {
                type: 'Point',
                coordinates: [3.41, 6.44],
                formattedAddress: '8 Island Close, Lagos',
                street: 'Island Close',
                city: 'Lagos',
                state: 'Lagos'
            },
        ...
        const p_drink1 = await ProductModel.create({
            name: 'Tropical Smoothie',
            description: 'Mango, pineapple, coconut',
            price: 2500,
            vendor: vendor3._id,
            category: catMap['Drinks & Beverages']._id,
            thumbnail:
                'https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=500',
            stock: 100
        });
        const p_dessert1 = await ProductModel.create({
            name: 'Chocolate Lava Cake',
            description: 'Warm chocolate cake, molten centre',
            price: 3000,
            vendor: vendor3._id,
            category: catMap['Desserts']._id,
            thumbnail:
        ...
        const rider1 = await RiderModel.create({
        ...
        const rider2 = await RiderModel.create({
        ...
        const addDelivery = async (
            ...
            return DeliveryModel.create({
                ...
                customerSignature:
                    'https://upload.wikimedia.org/wikipedia/commons/3/3a/Jon_Foreman_Signature.png',
                deliveryNotes: notes,
                createdAt: ts,
                updatedAt: ts
            });
        ...
        const orderA = await createOrder({
            ...
            status: 'delivered',
            completed: true,
            pickupLocation: [3.4245, 6.4311],
            deliveryLocation: [3.4215, 6.4281],
            pickup: pickupV1,
            destination: destAlice,
            products: [
                {
                    product: p_burger1._id,
                    name: p_burger1.name,
                    quantity: 1,
                    price: 4500,
                    category: 'Burgers'
            ...
            createdAt: isoBack(28),
            updatedAt: isoBack(28)
        });
        await addDelivery(
            orderA,
            rider1,
            'https://images.unsplash.com/photo-1566576721346-d4a3b4eaad5b?w=800',
            'Delivered to gate. Customer confirmed.',
            28
        );
        await addTx(
            custUser1._id,
        ...
        const orderB = await createOrder({
            ...
            status: 'delivered',
            completed: true,
            pickupLocation: [3.398, 6.455],
            deliveryLocation: [3.3958, 6.4531],
            pickup: pickupV2,
            destination: destBob,
            products: [
                {
            ...
            createdAt: isoBack(21),
            updatedAt: isoBack(21)
        });
        await addDelivery(
            orderB,
            rider2,
            'https://images.unsplash.com/photo-1580674285054-bed31e145f59?w=800',
            'Left at reception. Signed by security.',
            21
        );
        await addTx(
            custUser2._id,
        ...
        const orderC = await createOrder({
            ...
            createdAt: isoBack(14),
            updatedAt: isoBack(14)
        });
        await addDelivery(
            orderC,
            rider1,
            'https://images.unsplash.com/photo-1551782450-17144efb9c50?w=800',
            'Customer met at the door. Quick delivery!',
            14
        );
        await addTx(
            custUser1._id,
        ...
        const orderD = await createOrder({
            ...
            status: 'delivered',
            completed: true,
            pickupLocation: [3.41, 6.44],
            deliveryLocation: [3.358, 6.505],
            pickup: {
                street: 'Island Close',
                city: 'Lagos',
                state: 'Lagos',
            ...
            destination: destCarol,
            products: [
                {
                    product: p_drink1._id,
                    name: p_drink1.name,
                    quantity: 1,
                    price: 2500,
                    category: 'Drinks'
                ...
                {
                    product: p_dessert1._id,
                    name: p_dessert1.name,
                    quantity: 1,
                    price: 3000,
                    category: 'Desserts'
                }
        ...
        await addDelivery(
            ...
            'Left with neighbor. Called customer to confirm.',
            7
        );
        await addTx(
            custUser3._id,
        ...
        const orderE = await createOrder({
            ...
            status: 'delivered',
            completed: true,
            pickupLocation: [3.4215, 6.4281],
            deliveryLocation: [3.358, 6.505],
            pickup: destAlice,
            destination: destCarol,
            createdAt: isoBack(10),
            updatedAt: isoBack(10)
        });
        await addDelivery(
            orderE,
            rider1,
            'https://images.unsplash.com/photo-1519389950473-47ba0277781c?w=800',
            'Recipient signed. Documents intact.',
            10
        );
        await addTx(
            custUser1._id,
        ...
        const orderF = await createOrder({
            user: custUser2._id,
            vendor: vendor1._id,
            code: `ORD-${uid()}`,
            orderType: 'products',
        ...
        await DeliveryModel.create({
            order: orderF._id,
            status: 'pending',
            deliveryCode: orderF.code,
            deliveryFee: 1000,
            pickup: pickupV1,
            destination: destBob,
            receiverDetails: {
                name: 'Bob Williams',
                contactNumber: '08044444442'
            },
            senderDetails: {
                name: 'Burger Palace',
                contactNumber: '08022222221'
        ...
        const orderG = await createOrder({
            user: custUser1._id,
            vendor: vendor2._id,
            code: `ORD-${uid()}`,
            orderType: 'products',
        ...
        await DeliveryModel.create({
            ...
            senderDetails: { name: 'Pizza Hub', contactNumber: '08022222222' }
        });

        // Order H – Carol, package dispatched (in transit with rider)
        const orderH = await createOrder({
            user: custUser3._id,
            rider: riderUser2._id,
            code: `PKG-${uid()}`,
            orderType: 'package',
            package: {
                description: 'Gift Box – Fragile!',
                weight: 2.0,
                size: 'medium',
                isFragile: true
            },
        ...
        await DeliveryModel.create({
            ...
            receiverDetails: {
                name: 'Carol Davis',
                contactNumber: '08044444443'
            },
            senderDetails: { name: 'Sender', contactNumber: '08099999999' }
        });
        ...
        const orderJ = await createOrder({
            user: custUser1._id,
            vendor: vendor2._id,
            code: `ORD-${uid()}`,
            orderType: 'products',
        ...
        await ReviewModel.collection
                ...
                [
                    {
                        ...
                        rating: 5,
                        comment:
                            'Absolutely amazing burgers! Will order again.',
                        createdAt: isoBack(27),
                        updatedAt: isoBack(27)
                    },
                    {
                        user: custUser2._id,
                        vendor: vendor2._id,
                        ...
                        createdAt: isoBack(20),
                        updatedAt: isoBack(20)
                    },
                    {
                        user: custUser1._id,
                        vendor: vendor1._id,
                        order: orderC._id,
                        rating: 5,
                        comment: 'Best chicken burger in Lagos, no contest.',
                        createdAt: isoBack(13),
                        updatedAt: isoBack(13)
                    },
                    {
                        user: custUser1._id,
                        rider: rider1._id,
                        order: orderE._id,
                        rating: 5,
                        comment: 'Jason was super fast and friendly!',
                        createdAt: isoBack(9),
                        updatedAt: isoBack(9)
                    },
                    {
                        ...
                        order: orderB._id,
                        rating: 4,
                        comment: 'Mark was polite and careful with the food.',
                        createdAt: isoBack(20),
                        updatedAt: isoBack(20)
                    }
                ],
            ...
            .catch((e: any) => {
                ...
                console.log(
                    '   ⚠️  Some duplicate reviews skipped (expected on re-seed)'
                );
            });
        ...
        await PlatformRevenueModel.create({
            ...
            netAmount: 11250,
            payer: custUser1._id,
            payee: vendorUser1._id,
            status: 'SETTLED'
        });

        // Payouts
        const vendor1Wallet = await WalletModel.findOne({
        ...
        await ComplaintModel.create({
            ...
            description:
                'The delivery took too long and the pizza was mostly cold.',
            status: 'open',
            priority: 'medium'
        });
        ...
        await CouponModel.create({
            ...
            expiresOn: new Date(Date.now() + 86400000 * 30),
            isActive: true
        });
        ...
        console.log('\n  DATA SEEDED:');
        console.log(
            '  • 3 Market Categories, 5 Product Categories, 2 Vehicle Types'
        );
        console.log('  • 3 Vendors with 8 products total');
        console.log('  • 2 Riders with wallets');
        console.log(
            '  • 10 Orders (5 delivered, 3 in-progress, 1 pending, 1 canceled)'
        );
        console.log(
            '  • Deliveries with POD photos & signatures for all completed orders'
        );
        console.log(
            '  • Transactions (DEBIT/CREDIT/SETTLEMENT/DELIVERY) for all orders'
        );
        console.log('  • 5 Reviews (vendor & rider)');
        console.log('  • Wallets with realistic balances for all users');
        console.log(
            '  • Banners, Platform Revenue, Payouts, Refunds, KYC, Complaints, PerformanceMetrics, Coupons'
        );
        console.log('══════════════════════════════════════════════\n');
