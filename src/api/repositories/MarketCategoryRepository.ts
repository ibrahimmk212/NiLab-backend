...
class MarketCategoryRepository {
    ...
    async findMarketCategoryById(categoryId: string): Promise<MarketCategory | null> {
    ...
    async updateMarketCategory(
        ...
        return await MarketCategoryModel.findByIdAndUpdate(MarketCategoryId, updateData, {
            new: true
        });
    }

    async deleteMarketCategory(MarketCategoryId: string): Promise<MarketCategory | null> {
