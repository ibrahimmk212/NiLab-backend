...
const ReviewController_1 = __importDefault(require("../../../controllers/customers/ReviewController"));
...
const customerReviewRouter = (0, express_1.Router)();
...
exports.default = customerReviewRouter;
